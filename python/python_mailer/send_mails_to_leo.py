...
secure_port = 587
destinatarios = ['rodrigogenio15@hotmail.com','rodrigogenio12@gmail.com']

senha='sua senha' # or getpass() que vai exibr um prompt pedindo a sua senha mas não exibe os caracteres digitados
...
try:
    for destinatario in destinatarios:
        ...
        email_server.login(email, senha)
